    ...
    return (
        <>
            <div className='flex flex-col'>
                <div className='mb-4 lg:[&:nth-child()]:ml-4'>
                    <input className='text-black' onChange={(event) => handleChange(event, 'First')}></input><label className='ml-4'>First Name</label>
                </div>
                <div className='mb-4'>
                    <input className='text-black' onChange={(event) => handleChange(event, 'Last')}></input><label className='ml-4'>Last Name</label>
                </div>
                <div className='mb-4'>
                    <input className='text-black' onChange={(event) => handleChange(event, 'Department')}></input><label className='ml-4'>Department</label>
                </div>
            </div>
